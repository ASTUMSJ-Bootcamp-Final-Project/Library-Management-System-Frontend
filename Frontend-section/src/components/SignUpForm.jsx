  ...
  return (
    <div className="w-full max-w-md bg-white bg-opacity-80 rounded-xl shadow-2xl p-8 backdrop-blur-md">
      <div className="flex flex-col items-center mb-4">
        ...
        <p className="text-black mb-2 text-center">Join our library management system</p>
      </div>
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        <div className="flex gap-4">
          <div className="w-1/2">
            <label className="block text-blue-900 font-semibold mb-1" htmlFor="firstName">
              First Name
            </label>
          ...
          <div className="w-1/2">
            <label className="block text-blue-900 font-semibold mb-1" htmlFor="lastName">
              Last Name
            </label>
            <div className="relative">
              <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-blue-400">
        ...
        <div>
          <label className="block text-blue-900 font-semibold mb-1" htmlFor="email">
            Email Address
          </label>
          <div className="relative">
            <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-blue-400">
        ...
        <div>
          <label className="block text-blue-900 font-semibold mb-1" htmlFor="password">
            Password
          </label>
          <div className="relative">
            <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-blue-400">
        ...
        <div>
          <label className="block text-blue-900 font-semibold mb-1" htmlFor="confirmPassword">
            Confirm Password
          </label>
          <div className="relative">
            <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-blue-400">
        ...
        <div>
          <label className="block text-blue-900 font-semibold mb-1" htmlFor="adminCode">
